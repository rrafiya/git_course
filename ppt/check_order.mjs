...
const ORDER = {
  ...
  'a:clrScheme': ['a:dk1', 'a:lt1', 'a:dk2', 'a:lt2', 'a:accent1', 'a:accent2', 'a:accent3', 'a:accent4', 'a:accent5', 'a:accent6', 'a:hlink', 'a:folHlink', 'a:extLst'],
  'a:fontScheme': ['a:majorFont', 'a:minorFont', 'a:extLst'],
  'a:majorFont': ['a:latin', 'a:ea', 'a:cs', 'a:font', 'a:extLst'],
  'a:minorFont': ['a:latin', 'a:ea', 'a:cs', 'a:font', 'a:extLst'],
  'a:fmtScheme': ['a:fillStyleLst', 'a:lnStyleLst', 'a:effectStyleLst', 'a:bgFillStyleLst', 'a:extLst'],
  'a:fillStyleLst': ['a:noFill', 'a:solidFill', 'a:gradFill', 'a:blipFill', 'a:pattFill', 'a:grpFill'],
  'a:bgFillStyleLst': ['a:noFill', 'a:solidFill', 'a:gradFill', 'a:blipFill', 'a:pattFill', 'a:grpFill'],
  'a:lnStyleLst': ['a:ln'],
  'a:effectStyleLst': ['a:effectStyle'],
  'a:effectStyle': ['a:effectLst', 'a:effectDag', 'a:scene3d', 'a:sp3d', 'a:extLst'],
  'a:gradFill': ['a:gsLst', 'a:lin', 'a:path', 'a:tileRect'],
  'a:gsLst': ['a:gs'],
  'a:gs': ['a:schemeClr', 'a:srgbClr', 'a:sysClr', 'a:prstClr', 'a:scrgbClr', 'a:hslClr'],
  'a:solidFill': ['a:schemeClr', 'a:srgbClr', 'a:sysClr', 'a:prstClr', 'a:scrgbClr', 'a:hslClr'],
  'a:blipFill': ['a:blip', 'a:srcRect', 'a:tile', 'a:stretch'],
  'a:effectLst': ['a:blur', 'a:fillOverlay', 'a:glow', 'a:innerShdw', 'a:outerShdw', 'a:prstShdw', 'a:reflection', 'a:softEdge'],
  'a:outerShdw': ['a:srgbClr', 'a:schemeClr', 'a:prstClr', 'a:sysClr', 'a:scrgbClr', 'a:hslClr'],
  'a:scene3d': ['a:camera', 'a:lightRig', 'a:backdrop', 'a:extLst'],
  'a:sp3d': ['a:bevelT', 'a:bevelB', 'a:extrusionClr', 'a:contourClr', 'a:extLst'],
  'a:path': ['a:fillToRect', 'a:custGeom'],
  'a:camera': ['a:rot'],
  'a:lightRig': ['a:rot'],
  'p:viewPr': ['p:normalViewPr', 'p:slideViewPr', 'p:notesTextViewPr', 'p:gridSpacing', 'p:extLst'],
  'p:slideViewPr': ['p:cSldViewPr', 'p:sldViewPr'],
  'p:cSldViewPr': ['p:cViewPr', 'p:guideLst'],
